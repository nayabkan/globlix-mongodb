  ...
  <div class="header-wrapper row m-0">
      <form class="form-inline search-full col" action="#" method="get">
          <div class="form-group w-100">
            <div class="Typeahead Typeahead--twitterUsers">
              <div class="u-posRelative">
                  <input class="demo-input Typeahead-input form-control-plaintext w-100" type="text" placeholder="Search Globlix .." name="q" title="" autofocus>
          ...
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="{{ url('/') }}"><img class="img-fluid" src="{{ url('/') }}/admin/assets/images/logo/globlix.jpg" alt=""></a></div>
          ...
          <div class="nav-right col-8 pull-right right-header p-0">
            <ul class="nav-menus">
              ...
              <li class="profile-nav onhover-dropdown p-0 me-0">
                <div class="media profile-media"><img class="b-r-10" src="{{ url('/') }}/admin/assets/images/dashboard/profile.jpg" alt="">
                ...
                <ul class="profile-dropdown onhover-show-div">
                  ...
                  <li><a href="{{ route('logout') }}"  onclick="return confirm('Are you sure ?')"><i data-feather="log-in"> </i><span>Logout</span></a></li>
                </ul>
              </li>
            </ul>
          </div>
